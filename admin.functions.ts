...
export function CategoryTag({
  ...
  light?: boolean;
  asLink?: boolean;
  /** Nomes dos tópicos que ainda existem no painel — evita linkar para uma editoria removida (ex.: "Geral"). */
  ...
  const canLink = asLink && (!linkableTopics || linkableTopics.includes(category));
  if (canLink) {
    return (
